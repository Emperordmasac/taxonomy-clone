...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/workspaces/taxonomy-clone/lib/prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  config.dirname = path.join(process.cwd(), "lib/prisma")
...
path.join(process.cwd(), "lib/prisma/libquery_engine-debian-openssl-1.1.x.so.node")
