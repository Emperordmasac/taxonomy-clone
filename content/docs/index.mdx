---
title: Documentation
description: Welcome to the Pavilion documentation.
---

This is the documentation for the Pavilion site.

I'm going to use this to document all the features of Pavilion and how they are built. The documentation site is built using [ContentLayer](/docs/documentation/contentlayer) and MDX.
