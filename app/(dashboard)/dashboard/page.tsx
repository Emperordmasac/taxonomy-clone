      ...
      <div>
        {posts?.length ? (
          ...
          <EmptyPlaceholder>
            ...
            <PostCreateButton className="bg-white border-slate-200 text-brand-900 hover:bg-slate-100 focus:outline-none focus:ring-2 focus:ring-slate-500 focus:ring-offset-2" />
          </EmptyPlaceholder>
        )}
      </div>
    </DashboardShell>
