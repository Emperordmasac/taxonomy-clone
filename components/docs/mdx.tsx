...
const components = {
  ...
  pre: ({ className, ...props }) => (
    <pre
      className={cn(
        "mb-4 mt-6 overflow-x-auto rounded-lg bg-slate-100 py-4",
        className
      )}
      {...props}
    />
  ...
  code: ({ className, ...props }) => (
    <code
      className={cn(
        "relative rounded border bg-slate-300 bg-opacity-25 px-[0.3rem] py-[0.2rem] font-mono text-sm text-slate-600",
        className
      )}
      {...props}
    />
